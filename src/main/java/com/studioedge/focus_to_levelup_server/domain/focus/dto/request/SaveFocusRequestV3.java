...
public record SaveFocusRequestV3 (
        ...
        @NotNull(message = "집중 화면 시작 시각은 필수입니다.")
        @Schema(description = "집중 화면 시작 시각 (ISO 8601, UTC 또는 로컬 시간)", example = "2025-11-19T14:30:00")
        LocalDateTime screenStartTime,
        @NotNull(message = "과목 시작 시각은 필수입니다.")
        @Schema(description = "과목 시작 시각 (ISO 8601, UTC 또는 로컬 시간)", example = "2025-11-19T14:30:00")
        LocalDateTime subjectStartTime
){
}
