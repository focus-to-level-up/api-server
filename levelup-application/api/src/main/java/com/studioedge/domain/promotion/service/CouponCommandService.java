...
import com.studioedge.promotion.entity.CouponLog;
import com.studioedge.promotion.exception.CouponAlreadyUsedException;
import com.studioedge.promotion.exception.CouponExpiredException;
...
public class CouponCommandService {
    ...
    private MailType determineMailType(RewardType rewardType) {
        return switch (rewardType) {
            ...
            case ETC -> MailType.COUPON; // 쿠폰으로 받는 기타 보상 (구독권 등)
        };
    }
}
